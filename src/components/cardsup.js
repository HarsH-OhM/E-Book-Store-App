  ...
  return (
    <div className="main">
        ...
        <div class="row" style={{ margin: "10px" }}>
          <div class="col-sm-4">
            <div class="card" style={{ border: " 5px solid olive" }}>
              <img
                src="https://pyxis.nymag.com/v1/imgs/171/429/c95b07becc2bef532d9669b4824ea4386f-08-harry-potter.rhorizontal.w700.jpg"
                height="300px"
                alt="potter"
              />
              <div class="card-body">
          ...
          <div class="col-sm-4">
            <div class="card" style={{ border: " 5px solid olive" }}>
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSjuPGwhNDtaQCXDz1bc8GlqNQwisRpddvPCg&usqp=CAU"
                height="300px"
                alt="annefrank"
              />
              <div class="card-body">
          ...
          <div class="col-sm-4">
            <div class="card" style={{ border: " 5px solid olive" }}>
              <img
                src="https://i.pinimg.com/originals/f9/19/3b/f9193bbd0b0006cae6107a2ce597295a.png"
                height="300px"
                alt="avangers"
              />
              <div class="card-body">
      ...
      <Modal show={isOpen} onHide={hideModal} style={{ textAlign: "center" }}>
        ...
        <Modal.Body
          style={{
            backgroundImage: `url("https://i.pinimg.com/originals/31/1f/a6/311fa6499ff35c38a5c663c4fd94df99.jpg")`,
          }}
        >
...
export default connect(null)(CardsUp);
